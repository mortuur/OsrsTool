      ...
      <header className="bg-gradient-to-b from-zinc-900/70 to-zinc-900/90 border-b border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <h1 className="text-lg sm:text-2xl font-extrabold tracking-tight">OSRS Tool</h1>
            {/* TODO: nav to own file */}
            <nav className="flex gap-6">
              <Link className="text-green-300 hover:text-green-200" to="/">
                Home
              </Link>
              <Link className="text-green-300 hover:text-green-200" to="/about">
                About
              </Link>
            </nav>
          </div>
